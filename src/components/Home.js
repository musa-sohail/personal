    ...
    <div>
      <Section>
        <h1 className="text-5xl mb-3">
          Hi! I'm <span className="text-pink">Musa</span>!
        </h1>
        <h2 className="text-3xl">
          A Software Engineer from Islamabad,{" "}
          <span className="text-pink">Pakistan</span>
      ...
      <Section>
        <Text>
          Experienced in frontend and backend development, working with
          databases, AI, and vector embeddings.
        </Text>
        <Text>
          ...
          , is an interactive overview of who I am and some of the things that
          I've built. I encourage visitors to click around and explore (the
          sidebar and tabs at the top are fully functioning).
        </Text>
        <Text>
